        ...
        public static void Build(ContainerBuilder builder)
        {
            ...
            builder.Register<IMainReduxDispatcher>(
                ctx => new MainReduxDispatcher(
                            initialState: new RootState("Domači", "Gostujoči", "Domači", "Gostujoči", 0, 0, 0, 0, 0, PeriodType.BeforeGame, isTeamEdit: true, isEndGame: false,
            ...
            builder.RegisterType<RoosterViewModel>();
